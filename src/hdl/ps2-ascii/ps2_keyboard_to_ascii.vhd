...
ARCHITECTURE behavior OF ps2_keyboard_to_ascii IS
  TYPE machine IS(ready, new_code, translate, output, wait1, wait2, wait3, wait4);              --needed states
        ...
        WHEN translate =>
            ...
            ELSE --if control keys are not pressed  
              ...
              IF((shift_r = '0' AND shift_l = '0' AND caps_lock = '0') OR
                ...
                CASE ps2_code IS  
                    -- modified to force uppercase for Apple 1 
...
--                  WHEN x"1A" => ascii <= x"7A"; --z
        ...
        WHEN output =>
          ...
          END IF;
          state <= wait1;                    --return to ready state to await next PS2 code
