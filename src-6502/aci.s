...
SEPAR:            LDA     HEX1L           ; Copy hex value 1 to hex value 2
                STA     HEX2L
                LDA     HEX1H
                STA     HEX2H
...
; f=uencywill be a bit lower because of the additional workload between
; the twoloops.
...
HCOUNT:         LDY     #66             ; Extra long delay
                ...
                ADC     #$FE            ; Decrement A (CY=1 all the time) by 2
...
; bit length. All sub=uent loops don't have to be time compensated.
;-------------------------------------------------------------------------

WRITEBIT:       JSR     WDELAY          ; Do two=ual phases
